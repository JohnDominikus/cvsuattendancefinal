...
<head>
    ...
    <title>Student Attendance Sheet - CVSU Theme</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container mx-auto mt-4">
        ...
        <div class="table-container">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-data">
                    ...
                    <tr>
                        ...
                        <td><img src="../images/student_image/<?php echo htmlspecialchars($row['image']); ?>" alt="Student Image" class="student-image"></td>
            ...
            <div class="text-center">
                ...
                <a href="../dashboards/studentdash.php" class="back-btn mt-2">Back</a>
            </div>
            <?php else: ?>
